...
class TestPolyClipperSerialize(unittest.TestCase):
    ...
    def test_double(self):
        vals0 = [rangen.uniform(-100.0, 100.0) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    # int
    def test_int(self):
        vals0 = [rangen.randint(-100, 100) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_size_t(self):
        vals0 = [rangen.randint(0, 1000) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
            buf = serialize_size_t(x, buf)
        itr = 0
        vals1 = []
        for i in range(ntests):
    ...
    def test_string(self):
        ...
        vals0 = [''.join(rangen.choice(stuff) for j in range(20)) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_Vector2d(self):
        vals0 = [Vector2d(rangen.uniform(-100.0, 100.0),
                          rangen.uniform(-100.0, 100.0)) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_Vertex2d(self):
        vals0 = [Vertex2d(pos = Vector2d(rangen.uniform(-100.0, 100.0),
                                         rangen.uniform(-100.0, 100.0)),
                          c = rangen.randint(-1, -1)) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_Polygon(self):
        vals0 = [Polygon([Vertex2d(pos = Vector2d(rangen.uniform(-100.0, 100.0),
                                                  rangen.uniform(-100.0, 100.0)),
                                   c = rangen.randint(-1, -1)) for i in range(ntests)]) for j in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_Plane2d(self):
        vals0 = [Plane2d(p = Vector2d(rangen.uniform(-100.0, 100.0),
                         ...
                         id = rangen.randint(0, 1000)) for i in range(ntests)]
        buf = bytes()
        for x in vals0:
    ...
    def test_vector_of_Plane2d(self):
        vals0 = [[Plane2d(p = Vector2d(rangen.uniform(-100.0, 100.0),
                          ...
                          nhat = Vector2d(rangen.uniform(-1.0, 1.0),
                                        rangen.uniform(-1.0, 1.0)).unitVector(),
                          id = rangen.randint(0, 1000)) for i in range(ntests)] for j in range(ntests)]
        buf = bytes()
        for x in vals0:
