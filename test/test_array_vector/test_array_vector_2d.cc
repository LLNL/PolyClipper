...
struct ArrayAdapter2d {  
  ...
  static VECTOR Vector(double a, double b, double c)         { PCASSERT(false); }               // only 3D
  ...
  static double& z(VECTOR& a)                                { PCASSERT(false); }
  static double  x(const VECTOR& a)                          { return a[0]; }
  static double  y(const VECTOR& a)                          { return a[1]; }
  static double  z(const VECTOR& a)                          { PCASSERT(false); }
  ...
  static VECTOR  cross(const VECTOR& a, const VECTOR& b)     { PCASSERT(false); }                // only 3D
